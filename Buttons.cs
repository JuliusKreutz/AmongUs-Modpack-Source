    ...
    static class HudManagerStartPatch
    {
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            engineerRepairButton = new CustomButton(
                () =>
                {
                    ...
                    MessageWriter usedRepairWriter = AmongUsClient.Instance.StartRpcImmediately(
                        PlayerControl.LocalPlayer.NetId, (byte) CustomRPC.EngineerUsedRepair, Hazel.SendOption.Reliable,
                        -1);
            ...
            janitorCleanButton = new CustomButton(
                        ...
                        if (collider2D.tag == "DeadBody")
                        {
                            ...
                            if (component && !component.Reported)
                            {
                                ...
                                if (Vector2.Distance(truePosition2, truePosition) <=
                                    ...
                                    PlayerControl.LocalPlayer.POECPOEKKNO && !PhysicsHelpers.DOAHONIIFJD(truePosition,
                                        truePosition2, Constants.LEOCDMEJGPA, false))
                                {
                                    GameData.LGBOMGHJELL LGBOMGHJELL =
                                        GameData.Instance.GetPlayerById(component.ParentId);

                                    MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(
                                        PlayerControl.LocalPlayer.NetId, (byte) CustomRPC.JanitorClean,
                                        Hazel.SendOption.Reliable, -1);
                ...
                () =>
                {
                    return __instance.ReportButton.renderer.color == Palette.BJENLBHMKAI &&
                           PlayerControl.LocalPlayer.POECPOEKKNO;
                },
                () => { janitorCleanButton.Timer = janitorCleanButton.MaxTimer; },
            ...
            sheriffKillButton = new CustomButton(
                () =>
                {
                    ...
                    {
                        MessageWriter attemptWriter = AmongUsClient.Instance.StartRpcImmediately(
                    ...
                    byte targetId = 0;
                    if ((Sheriff.currentTarget.PPMOEEPBHJO.FDNMBJOAPFL &&
                    ...
                    MessageWriter killWriter = AmongUsClient.Instance.StartRpcImmediately(
                        PlayerControl.LocalPlayer.NetId, (byte) CustomRPC.SheriffKill, Hazel.SendOption.Reliable, -1);
            ...
            morphlingButton = new CustomButton(
                () =>
                {
                    ...
                    {
                        MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(
                            PlayerControl.LocalPlayer.NetId, (byte) CustomRPC.MorphlingMorph, Hazel.SendOption.Reliable,
                            -1);
            ...
            trackerButton = new CustomButton(
                ...
                () =>
                {
                    return PlayerControl.LocalPlayer.POECPOEKKNO && Tracker.currentTarget != null &&
                           !Tracker.usedTracker;
                },
                () => { },
            ...
            vampireKillButton = new CustomButton(
                () =>
                {
                    if (Helpers.handleMurderAttempt(Vampire.currentTarget))
                    {
                        ...
                        else
                        {
                            ...
                            HudManager.CHNDKKBEIDG.StartCoroutine(Effects.DCHLMIDMBHG(Vampire.delay,
                                new Action<float>((p) =>
                                {
                                    // Delayed action
                                    if (p == 1f)
                ...
                () =>
                {
                    ...
                    return Vampire.currentTarget != null && PlayerControl.LocalPlayer.POECPOEKKNO &&
            ...
            garlicButton = new CustomButton(
                ...
                () =>
                {
                    return !Vampire.localPlacedGarlic && !PlayerControl.LocalPlayer.PPMOEEPBHJO.IAGJEKLJCCI &&
            ...
            jackalSidekickButton = new CustomButton(
                ...
                () =>
                {
                    return Jackal.canCreateSidekick && Sidekick.sidekick == null && Jackal.fakeSidekick == null &&
                           Jackal.jackal != null && Jackal.jackal == PlayerControl.LocalPlayer &&
                           !PlayerControl.LocalPlayer.PPMOEEPBHJO.IAGJEKLJCCI;
                },
                () =>
                {
                    return Sidekick.sidekick == null && Jackal.fakeSidekick == null && Jackal.currentTarget != null &&
                           PlayerControl.LocalPlayer.POECPOEKKNO;
                },
            ...
            jackalKillButton = new CustomButton(
                () =>
                {
                    ...
                    MessageWriter killWriter = AmongUsClient.Instance.StartRpcImmediately(
                        PlayerControl.LocalPlayer.NetId, (byte) CustomRPC.JackalKill, Hazel.SendOption.Reliable, -1);
                    killWriter.Write(targetId);
                    AmongUsClient.Instance.FinishRpcImmediately(killWriter);
            ...
            sidekickKillButton = new CustomButton(
                () =>
                {
                    ...
                    MessageWriter killWriter = AmongUsClient.Instance.StartRpcImmediately(
                        PlayerControl.LocalPlayer.NetId, (byte) CustomRPC.SidekickKill, Hazel.SendOption.Reliable, -1);
                    killWriter.Write(targetId);
                    AmongUsClient.Instance.FinishRpcImmediately(killWriter);
