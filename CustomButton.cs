...
public class CustomButton
{
    ...
    public CustomButton(Action OnClick, Func<bool> HasButton, Func<bool> CouldUse, Action OnMeetingEnds, Sprite Sprite,
        Vector3 PositionOffset, HudManager hudManager, bool HasEffect, float EffectDuration, Action OnEffectEnds,
        bool mirror = false)
    {
    ...
    public CustomButton(Action OnClick, Func<bool> HasButton, Func<bool> CouldUse, Action OnMeetingEnds, Sprite Sprite,
        Vector3 PositionOffset, HudManager hudManager, bool mirror = false)
    ...
    private void Update()
    {
        if (PlayerControl.LocalPlayer.PPMOEEPBHJO == null || MeetingHud.Instance || ExileController.Instance ||
            !HasButton())
        {
            setActive(false);
            return;
        ...
        if (hudManager.UseButton != null)
        {
            ...
            if (hudManager.KillButton != null)
                hudManager.KillButton.transform.localPosition =
                    hudManager.UseButton.transform.localPosition -
                    new Vector3(1.3f, 0,
