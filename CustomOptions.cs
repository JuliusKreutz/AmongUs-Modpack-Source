    ...
    public class CustomOptionHolder
    {
        ...
        public static void Load()
        {
            ...
            detectiveFootprintIntervall =
                CustomOption.Create(122, "Footprint Intervall", 0.5f, 0.25f, 10f, 0.25f, detectiveSpawnRate);
            ...
            trackerUpdateIntervall =
                CustomOption.Create(201, "Tracker Update Intervall", 5f, 2.5f, 30f, 2.5f, trackerSpawnRate);
