...
namespace Modpack
{
    ...
    internal class ExileControllerDestroyPatch
    {
        private static void Prefix(UnityEngine.Object obj)
        {
            ...
            if (exiled != null && Mini.mini != null && Mini.mini.PlayerId == exiled.PlayerId && !Mini.isGrownUp() &&
                !Mini.mini.Data.IsImpostor)
            {
            ...
            if (Arsonist.arsonist == null || Arsonist.arsonist != PlayerControl.LocalPlayer) return;
            {
                ...
                var bottomLeft = new Vector3(-localPosition.x,
                    localPosition.y,
                    localPosition.z);
