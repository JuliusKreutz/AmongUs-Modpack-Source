...
namespace Modpack
{
    public class JackInTheBox
    {
        public static System.Collections.Generic.List<JackInTheBox> AllJackInTheBoxes =
            new System.Collections.Generic.List<JackInTheBox>();
        ...
        public static Sprite getJackInTheBoxSprite()
        {
            ...
            jackInTheBoxSprite = Helpers.loadSpriteFromResources("Modpack.Resources.JackInTheBox.png", 175f);
        ...
        public JackInTheBox(Vector2 p)
        {
            ...
            position += (Vector3) PlayerControl.LocalPlayer.Collider
                .offset; // add Player Collider offset as this gets subtracted again on Vent.DoMove
            // Create the marker
