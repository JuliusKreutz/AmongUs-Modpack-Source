...
namespace Modpack
{
    ...
    public static class Modpack
    {
        ...
        public static class Engineer
        {
            ...
            public static Sprite getButtonSprite()
            {
                ...
                buttonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.RepairButton.png", 115f);
                return buttonSprite;
            }
        ...
        public static class Janitor
        {
            ...
            {
                if (buttonSprite) return buttonSprite;
                buttonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.CleanButton.png", 115f);
                return buttonSprite;
            }
        ...
        public static class Lighter
        {
            ...
            {
                if (buttonSprite) return buttonSprite;
                buttonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.LighterButton.png", 115f);
                return buttonSprite;
            }
    ...
    public static class TimeMaster
    {
        ...
        {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.TimeShieldButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Medic
    {
        ...
        {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.ShieldButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Shifter
    {
        ...
        {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.ShiftButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Swapper
    {
        ...
        public static Sprite getCheckSprite()
        {
            ...
            spriteCheck = Helpers.loadSpriteFromResources("Modpack.Resources.SwapperCheck.png", 150f);
            return spriteCheck;
        }
    ...
    public static class Seer
    {
        ...
        public static Sprite getSoulSprite()
        {
            ...
            soulSprite = Helpers.loadSpriteFromResources("Modpack.Resources.Soul.png", 500f);
            return soulSprite;
        }
    ...
    public static class Morphling
    {
        ...
        public static void resetMorph()
        {
            ...
            morphling.SetHat(morphling.Data.HatId, morphling.Data.ColorId);
        ...
        public static Sprite getSampleSprite()
        {
            ...
            sampleSprite = Helpers.loadSpriteFromResources("Modpack.Resources.SampleButton.png", 115f);
            return sampleSprite;
        }
        ...
        public static Sprite getMorphSprite()
        {
            ...
            morphSprite = Helpers.loadSpriteFromResources("Modpack.Resources.MorphButton.png", 115f);
            return morphSprite;
        }
    }
    ...
    public static class Camouflager
    {
        ...
        {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.CamoButton.png", 115f);
            return buttonSprite;
        }
        ...
        public static void resetCamouflage()
        {
            ...
            {
                if (p == null) continue;
                if (Morphling.morphling != null && Morphling.morphling == p) continue;
    ...
    public static class Hacker
    {
        ...
        {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.HackerButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Tracker
    {
        ...
        {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.TrackerButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Vampire
    {
        ...
        {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.VampireButton.png", 115f);
            return buttonSprite;
        }
        ...
        public static Sprite getGarlicButtonSprite()
        {
            ...
            garlicButtonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.GarlicButton.png", 115f);
    ...
    public static class Jackal
    {
        ...
        public static PlayerControl currentTarget;
        public static readonly List<PlayerControl> formerJackals = new List<PlayerControl>();
        ...
        {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.SidekickButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Eraser
    {
        ...
        {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.EraserButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Trickster
    {
        ...
        public static Sprite getPlaceBoxButtonSprite()
        {
            ...
            placeBoxButtonSprite =
                Helpers.loadSpriteFromResources("Modpack.Resources.PlaceJackInTheBoxButton.png", 115f);
        ...
        public static Sprite getLightsOutButtonSprite()
        {
            ...
            lightOutButtonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.LightsOutButton.png", 115f);
        ...
        public static Sprite getTricksterVentButtonSprite()
        {
            ...
            tricksterVentButtonSprite =
                Helpers.loadSpriteFromResources("Modpack.Resources.TricksterVentButton.png", 115f);
    ...
    public static class Warlock
    {
        ...
        public static Sprite getCurseButtonSprite()
        {
            ...
            curseButtonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.CurseButton.png", 115f);
        ...
        public static Sprite getCurseKillButtonSprite()
        {
            ...
            curseKillButtonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.CurseKillButton.png", 115f);
    ...
    public static class SecurityGuard
    {
        ...
        public static Sprite getCloseVentButtonSprite()
        {
            ...
            closeVentButtonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.CloseVentButton.png", 115f);
        ...
        public static Sprite getPlaceCameraButtonSprite()
        {
            ...
            placeCameraButtonSprite = Helpers.loadSpriteFromResources("Modpack.Resources.PlaceCameraButton.png", 115f);
        ...
        public static Sprite getAnimatedVentSealedSprite()
        {
            ...
            animatedVentSealedSprite =
                Helpers.loadSpriteFromResources("Modpack.Resources.AnimatedVentSealed.png", 160f);
        ...
        public static Sprite getStaticVentSealedSprite()
        {
            ...
            staticVentSealedSprite = Helpers.loadSpriteFromResources("Modpack.Resources.StaticVentSealed.png", 160f);
    ...
    public static class Arsonist
    {
        ...
        public static Sprite getDouseSprite()
        {
            ...
            douseSprite = Helpers.loadSpriteFromResources("Modpack.Resources.DouseButton.png", 115f);
            return douseSprite;
        }
        ...
        public static Sprite getIgniteSprite()
        {
            ...
            igniteSprite = Helpers.loadSpriteFromResources("Modpack.Resources.IgniteButton.png", 115f);
            return igniteSprite;
        }
        ...
        public static void clearAndReload()
        {
            ...
            foreach (var p in dousedIcons.Values.Where(p => p != null && p.gameObject != null))
            {
