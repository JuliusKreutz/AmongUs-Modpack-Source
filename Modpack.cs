...
namespace Modpack
{
    ...
    public static class Lovers
    {
        ...
        {
            return lover1 != null && lover2 != null && !lover1.PPMOEEPBHJO.IAGJEKLJCCI &&
                   !lover2.PPMOEEPBHJO.IAGJEKLJCCI && !lover1.PPMOEEPBHJO.MFFAGDHDHLO &&
                   !lover2.PPMOEEPBHJO.MFFAGDHDHLO && !notAckedExiledIsLover; // ADD NOT ACKED IS LOVER
        }

        public static bool existingAndCrewLovers()
        {
            if (lover1 == null || lover2 == null || lover1.PPMOEEPBHJO.MFFAGDHDHLO || lover2.PPMOEEPBHJO.MFFAGDHDHLO)
                return false; // Null or disconnected
            return !(lover1.PPMOEEPBHJO.FDNMBJOAPFL || lover2.PPMOEEPBHJO.FDNMBJOAPFL || lover1 == Jackal.jackal ||
